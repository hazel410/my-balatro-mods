...
function G.UIDEF.shop()
  ...
  function create_UIBox_detailed_tooltip(_center)
    ...
    full_UI_table.from_detailed_tooltip = true
...
--[[
    ...
    contents.dollars_chips = {n=G.UIT.R, config={align = "cm",r=0.1, padding = 0,colour = G.C.DYN_UI.BOSS_MAIN, emboss = 0.05, id = 'row_dollars_chips', 
    cart_hover_func = Cartomancer.score_hover, }, nodes={
      {n=G.UIT.C, config={align = "cm", padding = 0.1}, nodes={
...
function create_UIBox_current_hand_row(handname, simple, in_collection)
  ...
  (not simple and
    {n=G.UIT.R, config={align = "cm", padding = 0.05, r = 0.1, colour = darken(G.C.JOKER_GREY, 0.1), emboss = 0.05, hover = true, force_focus = true, on_demand_tooltip = {text = localize(handname, 'poker_hand_descriptions'), filler = {func = create_UIBox_hand_tip, args = handname}}}, nodes={
      ...
      {n=G.UIT.C, config={align = "cm", padding = 0.05, colour =
          Cartomancer.SETTINGS.highlight_played_hands and (G.GAME.facing_blind and G.GAME.hands[handname].played_this_round >= 1) and G.C.SECONDARY_SET.Spectral or 
          G.C.L_BLACK,r = 0.1, minw = 0.9}, nodes={
...
function G.UIDEF.view_deck(unplayed_only)
  ...
  {n=G.UIT.ROOT, config={align = "cm", colour = G.C.CLEAR}, nodes={
    ...
    {n=G.UIT.R, config={align = "cm", minh = 0.8, padding = 0.05}, nodes={
      Cartomancer.add_view_deck_ui(unplayed_only),
  ...
  local t = create_UIBox_generic_options({padding = 0,back_label = localize('b_continue'), no_pip = true, snap_back = true, back_func = 'continue_unlock', minw = 4.5, contents = {
      {n=G.UIT.R, config={align = "cm", padding = 0}, nodes={
        {n=G.UIT.R, config={align = "cm", padding = 0.1}, nodes={
          {n=G.UIT.R, config={align = "cm", padding = 0.1}, nodes={
            {n=G.UIT.R, config={align = "cm", padding = 0}, nodes={
              {n=G.UIT.O, config={object = DynaText({string = { SMODS.create_unlock_text(card_center) }, colours = { G.C.BLUE }, shadow = true, rotate = true, bump = true, pop_in = 0.3, pop_in_rate = 2, scale = 1.2})}}
            }},
            {n=G.UIT.R, config={align = "cm", padding = 0}, nodes={
