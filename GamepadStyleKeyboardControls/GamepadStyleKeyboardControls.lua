--- STEAMODDED HEADER
--- MOD_NAME: Gamepad-Style Keyboard Controls
--- MOD_ID: GamepadStyleKeyboardControls
--- MOD_AUTHOR: [vgperson]
--- MOD_DESCRIPTION: Adds keyboard controls that simulate using a gamepad. (Edit list at top of LUA file to change assignments.)
...
local my_keybind_mapping = {
	["a"] = "dpleft", -- D-pad: Move cursor between cards and other UI elements
	["d"] = "dpright",
	["w"] = "dpup",
	["s"] = "dpdown",
	["j"] = "a", -- A button: Confirm, select/deselect/grab a card
	["i"] = "b", -- B button: Back, deselect all cards
	["k"] = "x", -- X button: Play hand (or discard, if inverted in game options), shortcut for shop reroll, shortcut to start/resume run in "play" menu
	["o"] = "y", -- Y button: Discard (or play hand, if inverted in game options), shortcut to go to next round in shop, shortcut to skip card pack
	["q"] = "leftshoulder", -- Left Bumper: Sell card, buy + use card from shop
	["e"] = "rightshoulder", -- Right Bumper: Use consumable, buy card/pack from shop
	["h"] = "triggerleft", -- Left Trigger: Peek at deek while held
	["u"] = "triggerright", -- Right Trigger: View full deck
	["enter"] = "back", -- Back/Select: Open Run Info screen
	["escape"] = "start" -- Start: Open pause menu
...
local changeButtonIconsToKeys = false -- Replaces button icons with key icons from the included keyboard_icons.png
...
if changeButtonIconsToKeys then
	SMODS.Atlas{key = "keyboard_icons", path = "keyboard_icons.png", px = 32, py = 32, prefix_config = { key = false } }
