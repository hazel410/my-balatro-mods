...
--- PREFIX: vap
--- MOD_AUTHOR: [sebulant]
--- MOD_DESCRIPTION: Vaporeon Deck
--- LOADER_VERSION_GEQ: 1.0.0
--- VERSION: 1.0.0
--- BADGE_COLOR: 48C7EA

local atlas_key = 'vap_atlas' -- Format: PREFIX_KEY
-- See end of file for notes
local atlas_path = 'vap_lc.png' -- Filename for the image in the asset folder
local atlas_path_hc = 'vap_hc.png' -- Filename for the high-contrast version of the texture, if existing

local suits = {'hearts', 'clubs', 'diamonds', 'spades'} -- Which suits to replace
local ranks = {'Jack', 'Queen', "King", "Ace"} -- Which ranks to replace

local description = 'Vaporeon' -- English-language description, also used as default
